...
function Lolly(props: LollyProps) {
  return (
    <svg
      className={`lollipop ${props.className}`}
      width={props.width ? props.width : "163px"} // 163px
      height={props.height ? props.height : "431px"} // 431px
      viewBox="0 0 163 431"
    >
      <defs>
        <path
      ...
      <g stroke="none" strokeWidth={1} fill="none" fillRule="evenodd">
        ...
        <use
          ...
          fill={props.fillBottom} // #deaa43
          fillRule="nonzero"
          xlinkHref="#a"
        />
        <path
          className="lollyTop"
          fill={props.fillTop} // #d52358
          fillRule="nonzero"
          mask="url(#b)"
